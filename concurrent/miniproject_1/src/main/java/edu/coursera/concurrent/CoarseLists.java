...
public final class CoarseLists {
    ...
    public static final class CoarseList extends ListSet {
        ...
        //Every instance of this inner class will be guarded by this lock against concurrent accesses!!
        ...
        boolean add(final Integer object) {
            try {
                //Acquiring the ReentrantLock lock!!
                lock.lock();
                ...
                //Releasing the ReentrantLock lock!!!
                lock.unlock();
            }
        }
    ...
    public static final class RWCoarseList extends ListSet {
        ...
        //Every object of this class will be protected by this lock from concurrent accesses!!!
        ...
        boolean contains(final Integer object) {
            try{
                ...
                //Don't forget it, otherwise write lock will never be acquired!!!
